...
1. Discard this _README.rdoc_ file and use the Rails' original one _README.rdoc.rails_
...
1. If you are brave enough you can unit test your JavaScript/CoffeeScript using Konacha
