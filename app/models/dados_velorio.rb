class DadosVelorio < ActiveRecord::Base
  ...
  validates :local_velorio, :endereco, presence: { message: "não pode ser vazio."}, if: :valida?
  validates :local_velorio, :endereco, length: {maximum: 255, message: "pode ter no máximo 255 caracteres."}, if: :valida?
