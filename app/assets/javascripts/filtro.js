function pago() {
    ...
    var url = window.location.href + '/contratantes/new?tipoOperacao=1';
...
function gratuito(){
	...
	$('#titulo_caixa').children().remove();
	var titulo = '<h1>Tipo de Contratação</h1>';
	var url = window.location.href + "/contratantes/new?tipoOperacao=2";
...
function registro_de_obito(){
	/* FINAL */
	var url = window.location.href + "/contratantes/new?tipoOperacao=3";
